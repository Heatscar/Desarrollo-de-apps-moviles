...
import static com.example.finalapps.MainActivity.mSQLiteHelper;
...
public class ListActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                final CharSequence[] items = {"Ver", "Actualizar", "Borrar"};

                AlertDialog.Builder dialog = new AlertDialog.Builder(ListActivity.this);
                dialog.setTitle("Selecciona una accion.");
    ...
    private void showDialogUpdate(Activity activity, final int position) {
        ...
        dialogUpdate.setTitle("Actualizar ...");
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    toastMessage("Actualizado exitoso.");
    ...
    private void showDialogDelete(final int position) {
        ...
        dialogDelete.setTitle("Borrar...");
        dialogDelete.setMessage("Seguro?");
        dialogDelete.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                try {
                    mSQLiteHelper.deleteData(position);
                    toastMessage("Borrado exitoso.");
                }
                catch (Exception e) {
    ...
    private void pickImageFromGallery() {
        ...
        startActivityForResult(Intent.createChooser(gallery, "Seleccionar imagen"), REQUEST_CODE_GALLERY);
    }
